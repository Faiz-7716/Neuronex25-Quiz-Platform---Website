...
const round4CybersecurityQuestions: Question[] = [
    {
        id: 401,
        round: 4,
        type: 'mcq',
...
// Round 4: Healthcare and AI
const round4HealthcareQuestions: Question[] = [
    { id: 501, round: 4, type: 'mcq', content: 'In medical imaging, what type of AI model is commonly used for tasks like identifying tumors in MRI or CT scans?', options: ['Recurrent Neural Networks (RNNs)', 'Convolutional Neural Networks (CNNs)', 'Generative Adversarial Networks (GANs)', 'Reinforcement Learning'], answer: 'Convolutional Neural Networks (CNNs)', status: 'available' },
    { id: 502, round: 4, type: 'mcq', content: 'What does the term "in silico" mean in the context of drug discovery?', options: ['Conducting experiments in a living organism.', 'Conducting experiments using computer simulations.', 'Conducting experiments in a test tube.', 'A clinical trial with human subjects.'], answer: 'Conducting experiments using computer simulations.', status: 'available' },
    { id: 503, round: 4, type: 'mcq', content: 'Which of the following is a major challenge for using AI in healthcare?', options: ['Lack of data.', 'Ensuring patient privacy and data security (adherence to HIPAA).', 'The slowness of computer processors.', 'AI models being too simple.'], answer: 'Ensuring patient privacy and data security (adherence to HIPAA).', status: 'available' },
    { id: 504, round: 4, type: 'mcq', content: 'What is the primary goal of using AI in personalized medicine?', options: ['To create one-size-fits-all treatments.', 'To reduce the cost of all medications.', 'To tailor medical treatment to the individual characteristics of each patient.', 'To replace doctors with AI.'], answer: 'To tailor medical treatment to the individual characteristics of each patient.', status: 'available' },
    { id: 505, round: 4, type: 'mcq', content: 'Natural Language Processing (NLP) in healthcare is most commonly used for:', options: ['Controlling surgical robots.', 'Analyzing genetic sequences.', 'Extracting information from electronic health records (EHRs).', 'Generating medical images.'], answer: 'Extracting information from electronic health records (EHRs).', status: 'available' },
    { id: 506, round: 4, type: 'mcq', content: 'What is "precision medicine"?', options: ['A field of medicine that uses general treatments for all patients.', 'An approach that customizes healthcare, with decisions and treatments tailored to each patient.', 'A type of surgery performed by robots.', 'The use of AI to predict the weather.'], answer: 'An approach that customizes healthcare, with decisions and treatments tailored to each patient.', status: 'available' },
    { id: 507, round: 4, type: 'mcq', content: 'What is a significant ethical concern regarding AI in healthcare?', options: ['The potential for AI to be too accurate.', 'The risk of algorithmic bias leading to health disparities.', 'The high cost of electricity to run AI models.', 'The difficulty of updating AI software.'], answer: 'The risk of algorithmic bias leading to health disparities.', status: 'available' },
    { id: 508, round: 4, type: 'mcq', content: 'Which of these is an example of a wearable device that collects health data for AI analysis?', options: ['A desktop computer.', 'A Fitbit or Apple Watch.', 'An MRI machine.', 'A hospital bed.'], answer: 'A Fitbit or Apple Watch.', status: 'available' },
    { id: 509, round: 4, type: 'mcq', content: 'In genomics, what can AI help to identify?', options: ['The location of the nearest hospital.', 'The price of a new drug.', 'Patterns in DNA that may be linked to diseases.', 'The number of patients in a clinic.'], answer: 'Patterns in DNA that may be linked to diseases.', status: 'available' },
    { id: 510, round: 4, type: 'mcq', content: 'What is a "digital twin" in the context of healthcare?', options: ['A robot that looks like a patient.', 'A virtual model of a patient used for simulations and treatment planning.', "A patient's online social media profile.", "A backup of a patient's electronic health record."], answer: 'A virtual model of a patient used for simulations and treatment planning.', status: 'available' },
    { id: 511, round: 4, type: 'mcq', content: 'Which AI technique is particularly useful for predicting disease outbreaks?', options: ['Image recognition.', 'Time-series analysis and forecasting.', 'Natural Language Generation (NLG).', 'Simple rule-based systems.'], answer: 'Time-series analysis and forecasting.', status: 'available' },
    { id: 512, round: 4, type: 'mcq', content: 'What does HIPAA stand for?', options: ['Health Information Portability and Accountability Act.', 'Healthcare Information and Patient Privacy Act.', 'Health Insurance Portability and Accountability Act.', 'Healthy Individual and Patient Action Act.'], answer: 'Health Insurance Portability and Accountability Act.', status: 'available' },
    { id: 513, round: 4, type: 'mcq', content: 'How can AI assist surgeons in the operating room?', options: ['By ordering lunch for the surgical team.', 'By providing real-time guidance and enhancing precision in robotic surgery.', "By communicating with the patient's family during surgery.", 'By automatically billing the patient.'], answer: 'By providing real-time guidance and enhancing precision in robotic surgery.', status: 'available' },
    { id: 514, round: 4, type: 'mcq', content: 'What is the purpose of "explainable AI" (XAI) in medical diagnosis?', options: ['To make AI models more complex.', 'To allow clinicians to understand how an AI model reached its conclusion.', "To hide the decision-making process of the AI.", "To speed up the AI's processing time."], answer: 'To allow clinicians to understand how an AI model reached its conclusion.', status: 'available' },
    { id: 515, round: 4, type: 'mcq', content: 'What type of AI is used in "virtual health assistants" or chatbots that answer patient questions?', options: ['Computer Vision.', 'Reinforcement Learning.', 'Natural Language Processing (NLP).', 'Unsupervised Learning.'], answer: 'Natural Language Processing (NLP).', status: 'available' },
    { id: 516, round: 4, type: 'mcq', content: 'What is a major benefit of using AI for drug discovery?', options: ['It makes the process more expensive.', 'It can significantly speed up the process of identifying promising drug candidates.', 'It guarantees that every drug will be successful.', 'It eliminates the need for human scientists.'], answer: 'It can significantly speed up the process of identifying promising drug candidates.', status: 'available' },
    { id: 517, round: 4, type: 'mcq', content: 'Which of the following is a risk of over-relying on AI for medical diagnosis?', options: ['The AI will always be correct.', 'A potential for misdiagnosis if the AI model is flawed or biased.', 'Doctors will have too much free time.', 'The cost of healthcare will decrease too quickly.'], answer: 'A potential for misdiagnosis if the AI model is flawed or biased.', status: 'available' },
    { id: 518, round: 4, type: 'mcq', content: 'What is "federated learning" in AI for healthcare?', options: ['Training a single AI model in a central location.', 'A method to train AI models across multiple decentralized devices or servers holding local data samples, without exchanging the data itself.', 'A type of learning exclusive to government hospitals.', 'A competition between different AI models.'], answer: 'A method to train AI models across multiple decentralized devices or servers holding local data samples, without exchanging the data itself.', status: 'available' },
    { id: 519, round: 4, type: 'mcq', content: 'How can AI help in managing chronic diseases like diabetes?', options: ['By providing a permanent cure.', 'By creating new types of sugar.', 'By analyzing patient data to predict blood sugar levels and recommend lifestyle changes.', 'By ordering insulin without a prescription.'], answer: 'By analyzing patient data to predict blood sugar levels and recommend lifestyle changes.', status: 'available' },
    { id: 520, round: 4, type: 'mcq', content: 'What is a key role of AI in analyzing medical literature?', options: ['To translate all papers into a single language.', 'To quickly scan and synthesize information from thousands of research papers.', 'To automatically reject papers with poor grammar.', 'To generate fake research papers.'], answer: 'To quickly scan and synthesize information from thousands of research papers.', status: 'available' },
    { id: 521, round: 4, type: 'mcq', content: 'What is the "black box" problem in AI?', options: ["A situation where it is difficult to understand how an AI model makes its decisions.", "A physical box that contains the AI's computer chip.", 'A problem that only occurs in the dark.', 'A term for a perfectly understood AI model.'], answer: "A situation where it is difficult to understand how an AI model makes its decisions.", status: 'available' },
    { id: 522, round: 4, type: 'mcq', content: 'In mental health, how can AI-powered tools be used?', options: ['To replace human therapists entirely.', 'To analyze speech patterns and text messages for signs of depression or anxiety.', "To prescribe medication without a doctor's approval.", 'To create stressful environments for exposure therapy.'], answer: 'To analyze speech patterns and text messages for signs of depression or anxiety.', status: 'available' },
    { id: 523, round: 4, type: 'mcq', content: 'What type of data is primarily used to train an AI model for medical image analysis?', options: ['Text from medical textbooks.', 'A large dataset of labeled images (e.g., X-rays with and without fractures).', "Audio recordings of doctors' notes.", 'Hospital financial records.'], answer: 'A large dataset of labeled images (e.g., X-rays with and without fractures).', status: 'available' },
    { id: 524, round: 4, type: 'mcq', content: 'Which of these tasks is an example of "predictive analytics" in healthcare?', options: ["Storing a patient's address.", 'Displaying an X-ray image.', 'Identifying patients at high risk of developing a certain disease in the future.', "Scheduling a doctor's appointment."], answer: 'Identifying patients at high risk of developing a certain disease in the future.', status: 'available' },
    { id: 525, round: 4, type: 'mcq', content: 'What is the role of the FDA (Food and Drug Administration) in AI for healthcare?', options: ['It has no role.', 'It regulates AI-based medical devices and software to ensure they are safe and effective.', 'It provides funding for all AI research.', 'It designs and builds its own AI models.'], answer: 'It regulates AI-based medical devices and software to ensure they are safe and effective.', status: 'available' },
    { id: 526, round: 4, type: 'mcq', content: 'How can AI improve the efficiency of clinical trials?', options: ['By eliminating the need for participants.', 'By helping to identify and recruit suitable candidates more quickly.', 'By making the trial medication more potent.', 'By guaranteeing a positive outcome for every trial.'], answer: 'By helping to identify and recruit suitable candidates more quickly.', status: 'available' },
    { id: 527, round: 4, type: 'mcq', content: 'What is an "Adversarial Attack" against a medical AI model?', options: ['A positive review from a rival hospital.', 'A power outage in the data center.', 'A technique to intentionally fool an AI model by providing it with deceptive input.', 'A disagreement between two doctors.'], answer: 'A technique to intentionally fool an AI model by providing it with deceptive input.', status: 'available' },
    { id: 528, round: 4, type: 'mcq', content: 'Which of the following is a key advantage of using robotic process automation (RPA) in healthcare administration?', options: ['It makes tasks more complicated.', 'It automates repetitive, rule-based tasks like billing and appointment scheduling.', 'It provides emotional support to patients.', 'It requires more staff to operate.'], answer: 'It automates repetitive, rule-based tasks like billing and appointment scheduling.', status: 'available' },
    { id: 529, round: 4, type: 'mcq', content: 'Why is data quality so important for healthcare AI?', options: ['It is not important.', 'High-quality data is needed for the AI to be able to make a diagnosis.', 'Inaccurate or biased data can lead to flawed and dangerous AI predictions.', 'The AI will refuse to work with low-quality data.'], answer: 'Inaccurate or biased data can lead to flawed and dangerous AI predictions.', status: 'available' },
    { id: 530, round: 4, type: 'mcq', content: 'What is "ambient clinical intelligence"?', options: ['A system that uses sensors and AI to listen to and document doctor-patient conversations automatically.', 'A type of mood lighting used in hospital rooms.', 'An AI that can predict the weather around a hospital.', 'A system that cleans the hospital air.'], answer: 'A system that uses sensors and AI to listen to and document doctor-patient conversations automatically.', status: 'available' }
];
...
export const allQuestions: Question[] = [
  ...
  ...round2Questions,
  ...round3Questions,
  ...round4CybersecurityQuestions,
  ...round4HealthcareQuestions
];
...
export const round4Topics = {
    cybersecurity: {
        title: 'Cyber Security',
        questions: round4CybersecurityQuestions,
    },
    healthcare: {
        title: 'Healthcare & AI',
        questions: round4HealthcareQuestions,
    }
}
